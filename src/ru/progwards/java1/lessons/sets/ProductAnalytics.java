...
//        2.11 Создать private List<Product> products - список всех имеющихся в ассортименте товаров. Все товары,
//             присутствующие в магазинах, обязательно присутствуют в products, но так же тут могут быть и товары,
...
//        2.14 Создать функцию public Set<Product> existAtListInOne() - товары из products, которые имеются хотя бы
//             в одном магазине
...
//        Магазин 3, товары: art-1,art-3,art-6,art-8,art-10
    ...
    public Set<Product> existAtListInOne() {
        ...
        for (Iterator<Shop> iterator = shops.iterator(); iterator.hasNext(); ) {
            Shop shopsProducts = iterator.next();
            //все товары из одного магазина
            aalShopProduct.addAll(shopsProducts.getProducts());
        }
...
//SetOperations.symDifference()
            if (i == 0) {
                products.addAll(shopsProducts.getProducts());//добавили сперва кол. магаз 1
                productsEnd.addAll(shopsProducts.getProducts());//добавили сперва кол. магаз 1
            } else {
                products.retainAll(shopsProducts.getProducts());//на втором круге сравнили кол 1 с кол 2
                ...
                products.addAll(shopsProducts.getProducts());//добавили эту колекцию в чистый products
